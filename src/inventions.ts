export interface Invention {
  name: string;
  year: number; // Conventional year of invention, patent, or first successful demonstration
...
export const inventions: Invention[] = [
  ...
  { name: "Movable-type printing press", year: 1440, inventor: "Johannes Gutenberg" },
  ...
  { name: "Mercury thermometer", year: 1714, inventor: "Daniel Gabriel Fahrenheit" },
  ...
  { name: "Sewing machine (practical)", year: 1830, inventor: "Barthélemy Thimonnier" },
  ...
  { name: "Anesthesia (ether, public demonstration)", year: 1846, inventor: "William T. G. Morton" },
  { name: "Safety elevator", year: 1852, inventor: "Elisha Otis" },
  { name: "Bessemer steel process", year: 1856, inventor: "Henry Bessemer" },
  { name: "Internal combustion engine (practical)", year: 1859, inventor: "Étienne Lenoir" },
  { name: "Pasteurization", year: 1864, inventor: "Louis Pasteur" },
  { name: "Dynamite", year: 1867, inventor: "Alfred Nobel" },
  { name: "Typewriter (commercial)", year: 1868, inventor: "Christopher Latham Sholes" },
  ...
  { name: "Practical incandescent light bulb", year: 1879, inventor: "Thomas Edison" },
  ...
  { name: "Pneumatic tire (practical)", year: 1888, inventor: "John Boyd Dunlop" },
  ...
  { name: "Safety razor (disposable blade)", year: 1901, inventor: "King Camp Gillette" },
  { name: "Air conditioning", year: 1902, inventor: "Willis Carrier" },
  { name: "Powered airplane", year: 1903, inventor: "Wright brothers" },
  { name: "Bakelite (first synthetic plastic)", year: 1907, inventor: "Leo Baekeland" },
  ...
  { name: "Insulin (isolated for treatment)", year: 1921, inventor: "Frederick Banting and Charles Best" },
  { name: "Television (electromechanical)", year: 1925, inventor: "John Logie Baird" },
  ...
  { name: "Aqualung (scuba)", year: 1943, inventor: "Jacques Cousteau and Émile Gagnan" },
  ...
  { name: "Shipping container (intermodal)", year: 1956, inventor: "Malcom McLean" },
  ...
  { name: "Google Search", year: 1998, inventor: "Larry Page and Sergey Brin" },
  { name: "iPhone", year: 2007 },
  { name: "Bitcoin", year: 2009, inventor: "Satoshi Nakamoto" },
  { name: "CRISPR gene editing (as a tool)", year: 2012, inventor: "Jennifer Doudna and Emmanuelle Charpentier" },
];
